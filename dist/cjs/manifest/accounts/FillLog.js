...
class FillLog {
    ...
    takerIsBuy;
    padding;
    constructor(market, maker, taker, price, baseAtoms, quoteAtoms, makerSequenceNumber, takerSequenceNumber, takerIsBuy, padding /* size: 15 */) {
        this.market = market;
        this.maker = maker;
        this.taker = taker;
        this.price = price;
    ...
    static fromArgs(args) {
        return new FillLog(args.market, args.maker, args.taker, args.price, args.baseAtoms, args.quoteAtoms, args.makerSequenceNumber, args.takerSequenceNumber, args.takerIsBuy, args.padding);
    }
    /**
